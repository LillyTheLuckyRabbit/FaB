...
int main(int argc, char *argv[]) {
	...
	if(!initSdlWindow(gWindow, gRenderer)) {
		...
		while(!quit) {
			...
			gTexture.render(0, 0, gRenderer, &gSpriteClips[0]);

			gTexture.render(SCREEN_WIDTH - gSpriteClips[1].w, 0,
							gRenderer, &gSpriteClips[1]);

			gTexture.render(0, SCREEN_HEIGHT - gSpriteClips[2].h,
							gRenderer, &gSpriteClips[2]);

			gTexture.render(SCREEN_WIDTH - gSpriteClips[3].w,
							SCREEN_HEIGHT - gSpriteClips[3].h,
							gRenderer, &gSpriteClips[3]);
